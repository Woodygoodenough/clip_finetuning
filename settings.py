...
if ON_COLAB:
    ...
    TRAIN_DATASET_PATTERN = "./webdataset_shards/clip_dataset_train.{000000..000260}.tar"
    VALID_DATASET_PATTERN = "./webdataset_shards/clip_dataset_valid.{000000..000032}.tar"
